      ...
      <table className="min-w-full bg-white border border-gray-300 shadow-lg rounded-lg overflow-hidden">
        <thead>
          <tr className="text-white bg-blue-600">
            ...
            <th className="border border-gray-300 p-4">Cédula</th>
            <th className="border border-gray-300 p-4">Nombre</th>
            <th className="border border-gray-300 p-4">Apellidos</th>
            <th className="border border-gray-300 p-4">Suite</th>
            <th className="border border-gray-300 p-4">Precio</th>
