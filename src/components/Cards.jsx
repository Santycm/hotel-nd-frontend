export const Cards = () => {
  ...
  return (
      ...
      <div className="card bg-purple-800 shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="card-info p-4">
          ...
          <p className="text-gray-400 font-semibold">Descripción del hotel 1</p>
        </div>
      </div>
      <div className="card bg-purple-800 shadow-lg rounded-lg overflow-hidden">
        <img src="./src/assets/imgHotel1.jpg" alt="hotel" className="w-full h-48 object-cover" />
        <div className="card-info p-4">
          ...
          <p className="text-gray-400 font-semibold">Descripción del hotel 2</p>
        </div>
      </div>
      <div className="card bg-purple-800 shadow-lg rounded-lg overflow-hidden">
        <img src="./src/assets/imgHotel1.jpg" alt="hotel" className="w-full h-48 object-cover" />
        <div className="card-info p-4">
          ...
          <p className="text-gray-400 font-semibold">Descripción del hotel 3</p>
        </div>
      </div>
    </div>
  );
