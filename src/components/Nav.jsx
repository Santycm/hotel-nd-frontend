  ...
  return (
          ...
          <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
            ...
            */}{" "}
            ...
            <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              {isLogged ? (
                <button
                  onClick={() => setIsLogged(false)} // Acción para desloguear al usuario
    ...
    */}
        ...
        <div
          className={
            open
              ? "opacity-100 scale-100 transition ease-out z-20 duration-200 absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden"
